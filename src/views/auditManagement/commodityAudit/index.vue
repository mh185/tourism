<template>
  <el-card>
    <el-tabs v-model="activeName" @tab-click="handleClick">
      <el-tab-pane label="商城商品" name="store">
        <!-- 状态选择器 -->
        ...
        >
          ...
          <el-table-column prop="jurisdiction" label="商品标题" width="130"></el-table-column>
          <el-table-column prop="jurisdiction" label="商品大类型" width="150"></el-table-column>
          <el-table-column prop="createTime" label="商品小类型" width="150"></el-table-column>
          <el-table-column prop="status" label="发布商家" width="150"></el-table-column>
      ...
      <el-tab-pane label="景区商品" name="scenicArea">
        <!-- 状态选择器 -->
        <el-select clearable v-model="status" placeholder="请选择">
          <el-option
            v-for="item in options"
        ...
        >
          ...
          <el-table-column prop="status" label="门票类型" width="150"></el-table-column>
          <el-table-column prop="status" label="发布商家" width="150"></el-table-column>
          <el-table-column prop="status" label="发布时间" width="150"></el-table-column>
      ...
      <el-tab-pane label="酒店商品" name="hotel">
        <!-- 状态选择器 -->
        <el-select clearable v-model="status" placeholder="请选择">
          <el-option
            v-for="item in options"
        ...
        >
          <el-table-column type="index" label="序号" width="50"></el-table-column>
          <el-table-column prop="jurisdiction" label="房间名称" width="180"></el-table-column>
          <el-table-column prop="status" label="房间数量" width="150"></el-table-column>
          <el-table-column prop="status" label="发布商家" width="150"></el-table-column>
          <el-table-column prop="status" label="发布时间" width="150"></el-table-column>
          <el-table-column prop="status" label="状态" width="150">
            <template slot-scope="scope">
