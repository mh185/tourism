<template>
  <el-card>
    ...
    <el-button class="addBtn" type="primary" @click="addCommodity">新增商品</el-button>
    <!-- 表格 -->
    <el-table
      :data="commodityList"
      border
    ...
    >
      ...
      <el-table-column prop="rolesName" label="门票名称" width="100"></el-table-column>
      <el-table-column prop="jurisdiction" label="商品类型" width="100"></el-table-column>
      <el-table-column prop="createTime" label="价格" width="100"></el-table-column>
      ...
      <el-table-column prop="status" label="操作">
        <el-button type="danger" size="mini" @click="removeCommodity()">删除</el-button>
        <el-button type="primary" size="mini" @click="examineStatus = true">查看</el-button>
        <el-button type="warning" size="mini" @click="editCommodity">编辑</el-button>
      </el-table-column>
    </el-table>
    <!-- 分页 -->
    <el-pagination
    ...
    <el-dialog title="新增商品" :visible.sync="addCommodityStatus" width="50%">
      <el-form :model="form">
        ...
        <el-form-item label="商品类型：" label-width="120px">
          <el-select clearable v-model="commodity" placeholder="请选择">
            <el-option
    ...
    <el-dialog title="编辑商品" :visible.sync="editStatus" width="50%">
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="addCommodityNotarize">确 定</el-button>
      </div>
    </el-dialog>
  </el-card>
</template>
...
export default {
  ...
  data() {
    return {
      ...
      pageSize: 1,
      pageNum: 1, //当前页数
      addCommodityStatus: false, //新增百科弹窗
