<template>
  <el-card>
    ...
    <el-button class="addBtn" type="primary" @click="addCourse">新增路线</el-button>
    <!-- 表格 -->
    <el-table
      :data="courseList"
      border
    ...
    >
      ...
      <el-table-column prop="rolesName" label="路线名称" width="100"></el-table-column>
      <el-table-column prop="jurisdiction" label="副标题" width="100"></el-table-column>
      <el-table-column prop="createTime" label="标签" width="100"></el-table-column>
      <el-table-column prop="status" label="发布人" width="100"></el-table-column>
      <el-table-column prop="status" label="发布时间" width="150"></el-table-column>
      <el-table-column prop="status" label="状态" width="100"></el-table-column>
      <el-table-column prop="status" label="审核时间" width="100"></el-table-column>
      ...
      <el-table-column prop="status" label="操作">
        <el-button type="danger" size="mini" @click="removeCourse()">删除</el-button>
        <el-button type="primary" size="mini" @click="examineStatus = true">查看</el-button>
        <el-button type="warning" size="mini" @click="editCourse">编辑</el-button>
      </el-table-column>
    </el-table>
    <!-- 分页 -->
    <el-pagination
    ...
    ></el-pagination>
    <!-- 弹窗 ->新增百科 -->
    <el-dialog title="新增百科" :visible.sync="addCourseStatus" width="50%">
      <el-form :model="form">
        <el-form-item label="门票名称：" label-width="120px">
          <el-input v-model="form.name" clearable placeholder="请输入"></el-input>
        </el-form-item>
        <el-form-item label="商品类型：" label-width="120px">
          <el-select clearable v-model="course" placeholder="请选择">
            <el-option
        ...
        <el-form-item label="门票简介：" label-width="120px">
          <el-input v-model="form.fullName" clearable placeholder="请输入" type="textarea"></el-input>
        </el-form-item>
        <el-form-item label="预定须知：" label-width="120px">
      ...
      <div slot="footer" class="dialog-footer">
        <el-button @click="addCourseStatus = false">取 消</el-button>
    ...
    <el-dialog title="编辑商品" :visible.sync="editStatus" width="50%">
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="addCourseNotarize">确 定</el-button>
      </div>
    </el-dialog>
  </el-card>
</template>
