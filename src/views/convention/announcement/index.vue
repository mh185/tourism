<template>
  <el-card>
    ...
    <el-button
      ...
      @click="refresh"
    >重置</el-button>
    <el-button class="addBtn" type="primary" @click="add">新增公告</el-button>
    <!-- 表格 -->
    <el-table
    ...
    />
    <!-- 弹窗 ->新增 -->
    <el-dialog title="新增公告" :visible.sync="addStatus" width="50%">
      <el-form :model="form">
    ...
    <!-- 弹窗 ->编辑 -->
    <el-dialog title="编辑公告" :visible.sync="editStatus" width="50%">
      <el-form :model="form">
        <el-form-item label="标题：" label-width="120px">
          <el-input
            v-model="form.title"
    ...
    <!-- 弹窗 ->查看 -->
    <el-dialog title="查看公告" :visible.sync="lookStatus" width="50%">
      <el-form :model="form">
        <el-form-item label="标题：" label-width="120px">
          {{ form.title }}
        </el-form-item>
...
import { pageQuery, insert, deleteId, update } from '@/api/announcement'
export default {
  name: 'TinymceDemo',
