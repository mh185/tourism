<template>
  <el-card>
    ...
    <el-button class="addBtn" type="primary" @click="add">新增考察点</el-button>
    <!-- 表格 -->
    <el-table
    ...
    >
      ...
      <el-table-column prop="areaName" label="所属区域" :show-overflow-tooltip="true" />
    ...
    />
    <!-- 弹窗 ->新增 -->
    <el-dialog title="新增考察点" :visible.sync="addStatus" width="50%">
    ...
    <!-- 弹窗 ->编辑 -->
    <el-dialog title="编辑考察点" :visible.sync="editStatus" width="50%">
...
<script>
import { pageQuery, queryObservationScenicSpotList, deleteId, insert, updateVO } from '@/api/inspectionPoint'
export default {
  data() {
    return {
      addStatus: false, // 新增
  ...
  methods: {
    ...
    // 编辑 - 弹框
    edit(content) {
      queryObservationScenicSpotList().then(res => {
