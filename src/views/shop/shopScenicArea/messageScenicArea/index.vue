<template>
  <el-card>
    ...
    <el-button class="addBtn" type="primary" @click="addInformation">新增资讯</el-button>
    <!-- 表格 -->
    <el-table
    ...
    >
      ...
      <el-table-column prop="rolesName" label="标题" width="100"></el-table-column>
      <el-table-column prop="jurisdiction" label="简介" width="100"></el-table-column>
      <el-table-column prop="createTime" label="排序" width="150"></el-table-column>
      ...
      <el-table-column prop="status" label="操作">
        <el-button type="danger" size="mini" @click="removeInformation()">删除</el-button>
        <el-button type="primary" size="mini" @click="examineStatus = true">查看</el-button>
        <el-button type="warning" size="mini" @click="editInformation">编辑</el-button>
      </el-table-column>
    </el-table>
    <!-- 分页 -->
    <el-pagination
    ...
    ></el-pagination>
    <!-- 弹窗 ->新增资讯 -->
    <el-dialog title="新增资讯" :visible.sync="addInformationStatus" width="50%">
      <el-form :model="form">
      ...
      <div slot="footer" class="dialog-footer">
        <el-button @click="addInformationStatus = false">取 消</el-button>
        <el-button type="primary" @click="addGoods">确 定</el-button>
      </div>
    </el-dialog>
    <!-- 弹窗 ->查看资讯 -->
    <el-dialog title="查看资讯" :visible.sync="examineStatus" width="50%">
      <el-form :model="form">
        <el-form-item label="标题：" label-width="120px">
    ...
    <!-- 弹窗 ->编辑资讯 -->
    <el-dialog title="编辑资讯" :visible.sync="editStatus" width="50%">
      <el-form :model="form">
        <el-form-item label="标题：" label-width="120px">
          <el-input v-model="form.name" clearable placeholder="请输入"></el-input>
        </el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      pageSize: 1,
      pageNum: 1, //当前页数
      addInformationStatus: false, //新增百科弹窗
  ...
  methods: {
    ...
    //新增资讯 => 弹窗
    addInformation() {
      this.addInformationStatus = true;
    },
    //新增资讯 => 发送请求
    addGoods() {
      this.addInformationStatus = false;
      console.log("成功");
    },
    //分页
